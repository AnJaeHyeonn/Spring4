...
<table class="table table-dark table-striped">
	...
	<c:forEach items="${comments}" var="comment">
		<tr>
			...
			<c:if test="${not empty member and member.id==comment.writer}">
				<td>
...
<nav aria-label="Page navigation example">
	<ul class="pagination">
		...
		<li class="page-item"><span class="page-link more" data-comment-pn="${pager.lastNum+1}" aria-label="Next">
				<span aria-hidden="true">&gt;</span>
		</span></li>

		<li class="page-item"><span class="page-link more" data-comment-pn="${pager.totalPage}" aria-label="Next">
